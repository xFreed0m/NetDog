...
def usage():
		...
		\_\ \/ \___|\__/___,' \___/ \__, |
				    	    |___/ 
        """
        print "Usage: netdog.py -t target_host -p target_port"
        ...
        print "echo 'ABCDEFGHI' | ./netdog.py -t 192.168.1.1 -p 135"
        sys.exit(0)
...
def main():
        ...
        # we are going to listen to potentially
...
def client_handler(client_socket):
        ...
        if command:
                ...
                while True:
                        ...
                        client_socket.send("<NetDog-Shell:#> ")
